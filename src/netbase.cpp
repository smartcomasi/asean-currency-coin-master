...
int CNetAddr::GetReachabilityFrom(const CNetAddr *paddrPartner) const
{
    ...
    case NET_ACCOIN:
        ...
        case NET_ACCOIN:    return REACH_PRIVATE;
        }
    case NET_I2P:
        switch(ourNet) {
        default:         return REACH_DEFAULT;
    ...
    default:
        ...
        case NET_ACCOIN:     return REACH_PRIVATE; // either from Tor/I2P, or don't care about our address
        }
    }
}
