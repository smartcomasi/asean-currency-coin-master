// Copyright (c) 2014 The Aseancoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("aseancoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("aseancoin-smsg-pow"); // Make this thread recognisable
