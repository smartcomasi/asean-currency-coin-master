    ...
    address(addr)
{
    ...
    if (label.trimmed().isEmpty()) {
        setWindowTitle(QString("Aseancoin - Generate QR Code"));
    } else {
        setWindowTitle(QString("Aseancoin - Generate QR Code for %1").arg(label));
    }
...
{
    QString ret = QString("aseancoin:%1").arg(address);
    int paramCount = 0;
