...
void StatisticsPage::updateStatistics()
{
    ...
    int64_t volume = ((pindexBest->nMoneySupply)/5,000,000,000);
    ...
    QString phase = "";
    if (pindexBest->nHeight < 21000000)
    {
        phase = "Tribus Proof of Work (POS Fully Starts Block 21000000)";
    }
    else if (pindexBest->nHeight > 21000000)
    {
        phase = "PoS (5% per year variable)";
    }

    QString subsidy = "";
	if (pindexBest->nHeight <= 21000000)
    {
        subsidy = "500 ACCOIN per block";
    }
    else if (pindexBest->nHeight > 21000000)
    {
        subsidy = "Full PoS";
    ...
    {
        ui->volumeBox->setText("<b><font color=\"yellow\">" + qVolume + " ACCOIN" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " ACCOIN" + "</font></b>");
    } else {
        ui->volumeBox->setText("<b><font color=\"orange\">" + qVolume + " ACCOIN" + "</font></b>");
    }
